...
class COCODetection(data.Dataset):
    ...
    def pull_image(self, index):
        ...
        filename = str(self.coco.loadImgs(img_id)[0]["file_name"])
        res = str(self.imgs_path) +"/" + str("0"* (8-len(filename)) + filename)
        # print(res)
...
def get_dataset(config):
    ...
    transform = get_transform(config['img_size'], transform_type="strong")
